...
class ActivityTentang : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val label = ("PENGGUNAAN APLIKASI INI MENUNJUKKAN PENERIMAAN DAN KEPATUHAN TERHADAP SYARAT DAN KETENTUAN DIBAWAH INI.\n" +
                "\n" +
                "       Selamat datang di Aplikasi AGENT TRAVEL, suatu aplikasi berbasis Android yang menyediakan jasa dalam bidang transportasi darat (mobil, bus, dan minibus) atau jasa akomodasi saat perjalanan.\n" +
